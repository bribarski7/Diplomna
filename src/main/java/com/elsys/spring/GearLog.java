...
public class GearLog {
    ...
    public GearLog(int inRpm, int outRpm, int gear, float temperature) {
        this.inRpm = inRpm;
        this.outRpm = outRpm;
        this.gear = gear;
        this.time = Timestamp.from(Instant.now());
    ...
    public String toString() {
        return String.format("GearLog: id=%d inRpm=%d outRpm=%d gear=%c time=%s temperature=%f", this.getId(), this.getInRpm(), this.getOutRpm(), this.getGear(), this.getTime(), this.getTemperature());
    }
}
